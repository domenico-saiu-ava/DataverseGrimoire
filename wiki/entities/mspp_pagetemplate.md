...
| Name | Target entity | Referencing attribute | Navigation property |
| --- | --- | --- | --- |
| `mspp_pagetemplate_webpage` | _n/a_ | `mspp_pagetemplateid` | _n/a_ |


## Source

Generated from [mspp_pagetemplate.md](https://github.com/MicrosoftDocs/powerapps-docs/blob/main/powerapps-docs/developer/data-platform/reference/entities/mspp_pagetemplate.md) on 2026-05-06.