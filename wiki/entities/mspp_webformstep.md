...
| Name | Target entity | Referencing attribute | Navigation property |
| --- | --- | --- | --- |
| `mspp_webform_startstep` | _n/a_ | `mspp_startstep` | _n/a_ |
| `mspp_webformmetadata_webformstep` | _n/a_ | `mspp_webformstep` | _n/a_ |
| `mspp_webformstep_conditiondefaultnextstep` | _n/a_ | `mspp_conditiondefaultnextstep` | _n/a_ |
| `mspp_webformstep_entitysourcestep` | _n/a_ | `mspp_entitysourcestep` | _n/a_ |
| `mspp_webformstep_nextstep` | _n/a_ | `mspp_nextstep` | _n/a_ |
| `mspp_webformstep_previousstep` | _n/a_ | `mspp_previousstep` | _n/a_ |
| `mspp_webformstep_referenceentitystep` | _n/a_ | `mspp_referenceentitystep` | _n/a_ |


## Source

Generated from [mspp_webformstep.md](https://github.com/MicrosoftDocs/powerapps-docs/blob/main/powerapps-docs/developer/data-platform/reference/entities/mspp_webformstep.md) on 2026-05-06.