...
`ImportSequenceNumber`, `msdyn_childgranularpredictions`, `msdyn_forecastconfigurationid`, `msdyn_forecastid`, `msdyn_forecastidPId`, `msdyn_forecastpredictiondataId`, `msdyn_forecastrecurrenceid`, `msdyn_forecastrecurrenceidPId`, `msdyn_hierarchyrecordid`, `msdyn_parentgranularpredictions`, `msdyn_predictionon`, `OverriddenCreatedOn`, `PartitionId`, `TTLInSeconds`
...
Generated from [msdyn_forecastpredictiondata.md](https://github.com/MicrosoftDocs/dynamics-365-customer-engagement/blob/main/ce/developer/reference/entities/msdyn_forecastpredictiondata.md) on 2026-05-06.