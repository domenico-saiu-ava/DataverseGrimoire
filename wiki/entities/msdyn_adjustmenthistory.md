...
`ImportSequenceNumber`, `msdyn_adjustmenthistory`, `msdyn_adjustmenthistoryId`, `msdyn_forecastconfigurationcolumnid`, `msdyn_forecastconfigurationid`, `msdyn_forecastid`, `msdyn_forecastidPId`, `msdyn_forecastinstancecolumngrouptype`, `OverriddenCreatedOn`, `PartitionId`, `TTLInSeconds`
...
Generated from [msdyn_adjustmenthistory.md](https://github.com/MicrosoftDocs/dynamics-365-customer-engagement/blob/main/ce/developer/reference/entities/msdyn_adjustmenthistory.md) on 2026-05-06.