...
display: "Metadati modulo di base"
...
# Metadati modulo di base

Definisce la logica di modifica del comportamento aggiuntiva per migliorare o sostituire la funzionalità dei componenti del modulo, operazione impossibile da eseguire con i metadati del modulo e dell'entità Dynamics 365.
...
| Display name | Metadati modulo di base |
| Display (plural) | Metadati modulo di base |
...
Generated from [mspp_entityformmetadata (live)](https://crmoperativodevevo.crm4.dynamics.com/api/data/v9.2/EntityDefinitions(LogicalName='mspp_entityformmetadata')) on 2026-05-07.